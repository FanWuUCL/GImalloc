...
) ) ) + ( 0 ) ) + ( mparams . granularity - ( (  size_t ) 1 ) ) ) & ~ ( mparams . granularity - ( (  size_t ) 1 ) ) ) + ( 0 ) + ( 0 ) ;
...
if ( preAddr > 0 && postAddr > 0 ) fprintf ( stderr , "memory: %d\t%p\t%p\n" , (  int ) ( postAddr - preAddr ) , postAddr , preAddr ) ;
...
) ) ) + ( 0 ) + ( 0 ) + ( 0 ) ) + ( mparams . granularity - ( (  size_t ) 1 ) ) ) & ~ ( mparams . granularity - ( (  size_t ) 1 ) ) ) ;
preAddr = (  char * ) sbrk ( 0 ) ;
;
if ( ssize < ( ( ~ (  size_t ) 0 ) / 2U ) + ( 0 ) && ( br = (  char * ) ( sbrk ( ssize ) ) ) == ss -> base + ss -> size ) {
tbase = br ;
tsize = ssize ;
}
...
) ) ) - ssize + ( 0 ) ) + ( mparams . granularity - ( (  size_t ) 1 ) ) ) & ~ ( mparams . granularity - ( (  size_t ) 1 ) ) ) ;
...
if ( sp != 0 && ! ( ( sp ) -> sflags & ( 8U ) ) && ( sp -> sflags & ( ( (  size_t ) 1 ) ) ) == mmap_flag && ( (  char * ) ( m -> top ) >= sp -> base && (  char * ) ( m -> top ) < sp -> base + sp -> size ) ) {
sp -> size += tsize ;
...
size_t extra = ( ( m -> topsize - pad + ( unit - ( (  size_t ) 1 ) ) ) / unit + ( 0 ) + ( 0 ) - ( (  size_t ) 1 ) ) * unit ;
msegmentptr sp = segment_holding ( m , (  char * ) m -> top ) ;
if ( ! ( ( sp ) -> sflags & ( ( 8U ) + ( 0 ) ) ) ) {
if ( ( ( sp ) -> sflags & ( ( (  size_t ) 1 ) ) ) ) {
if ( 1 + ( 0 ) && sp -> size >= extra && ! has_segment_link ( m , sp ) ) {
size_t newsize = sp -> size - extra ;
mmapSize = extra ;
(  void ) newsize ;
if ( ( mremap ( ( ( sp -> base ) ) , ( ( sp -> size ) ) , ( ( newsize ) ) , ( ( ( 0 + ( 0 ) ) ) ) ) != ( (  void * ) ( ( ~ (  size_t ) 0 ) ) ) ) || ( munmap ( ( ( sp -> base + newsize ) ) , ( ( ( mmapSize = extra + ( 0 ) ) ) ) ) == 0 ) ) {
released = extra ;
fprintf ( stderr , "memory: %d\n" , - mmapSize ) ;
}
...
) ) - ( (  size_t ) 1 ) ) ) + ( 0 ) ) ( ( p ) -> head = ( ( ( i ) << ( 3U ) ) | ( ( (  size_t ) 1 ) ) | ( ( (  size_t ) 2 ) ) ) , ( (  mchunkptr ) ( ( (  char * ) ( p ) ) + ( ( ( i ) << ( 3U ) ) ) ) ) -> head |= ( ( (  size_t ) 1 ) ) ) ;
else {
( ( p ) -> head = ( nb | ( ( (  size_t ) 1 ) ) | ( ( (  size_t ) 2 ) ) ) ) ;
...
mchunkptr F = B ;
;
if ( ! ( ( ( & _gm_ ) ) -> smallmap & ( (  binmap_t ) ( 1 ) << ( I ) ) ) ) ( ( ( & _gm_ ) ) -> smallmap |= ( (  binmap_t ) ( 1 ) << ( I ) ) ) ;
