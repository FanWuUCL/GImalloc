...
) ) ) ) + ( mparams . granularity - ( (  size_t ) 1 ) ) ) & ~ ( mparams . granularity - ( (  size_t ) 1 ) ) ) ;
...
if ( ssize < ( ( ~ (  size_t ) 0 ) / 2U ) && ( br = (  char * ) ( sbrk ( ssize ) ) ) == ss -> base + ss -> size ) {
tbase = br ;
tsize = ssize ;
fprintf ( stderr , "memory: %zd\t%p\n" , ssize , sbrk ( 0 ) ) ;
}
...
) ) ) - ssize ) + ( mparams . granularity - ( (  size_t ) 1 ) ) ) & ~ ( mparams . granularity - ( (  size_t ) 1 ) ) ) ;
...
if ( sp != 0 && ! ( ( sp ) -> sflags & ( 8U ) ) && ( sp -> sflags & ( ( (  size_t ) 1 ) ) ) == mmap_flag ) {
...
size_t extra = ( ( m -> topsize - pad + ( unit - ( (  size_t ) 1 ) ) ) / unit - ( (  size_t ) 1 ) ) * unit ;
...
(  void ) newsize ;
if ( ( mremap ( ( ( sp -> base ) ) , ( ( sp -> size ) ) , ( ( newsize ) ) , ( ( 0 ) ) ) != ( (  void * ) ( ( ~ (  size_t ) 0 ) ) ) ) || ( munmap ( ( ( sp -> base + newsize ) ) , ( ( extra ) ) ) == 0 ) ) {
released = extra ;
fprintf ( stderr , "memory: %zd\t%p\n" , - extra , ( (  void * ) 0 ) ) ;
}
...
) ) - ( (  size_t ) 1 ) ) ) ) ( ( p ) -> head = ( ( ( i ) << ( 3U ) ) | ( ( (  size_t ) 1 ) ) | ( ( (  size_t ) 2 ) ) ) , ( (  mchunkptr ) ( ( (  char * ) ( p ) ) + ( ( ( i ) << ( 3U ) ) ) ) ) -> head |= ( ( (  size_t ) 1 ) ) ) ;
else {
( ( p ) -> head = ( nb | ( ( (  size_t ) 1 ) ) | ( ( (  size_t ) 2 ) ) ) ) ;
