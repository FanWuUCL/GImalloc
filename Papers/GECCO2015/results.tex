...
\begin{figure*}[htbp]
	...
	\subfigure[espresso]{
		...
		\includegraphics[width=0.4\textwidth]{espresso_shallow_random}
	}
	\subfigure[gawk]{
		\label{fig_shallow_random_gawk}
		\includegraphics[width=0.4\textwidth]{gawk_shallow_random}
	}
	\subfigure[flex]{
		\label{fig_shallow_random_flex}
		\includegraphics[width=0.4\textwidth]{flex_shallow_random}
	}
	\subfigure[sed]{
		\label{fig_shallow_random_sed}
		\includegraphics[width=0.4\textwidth]{sed_shallow_random}
	}
...
\begin{figure*}[htbp]
	...
	\subfigure[espresso]{
		...
		\includegraphics[width=0.4\textwidth]{espresso_deep_shallow}
	}
	\subfigure[gawk]{
		\label{fig_deep_shallow_gawk}
		\includegraphics[width=0.4\textwidth]{gawk_deep_shallow}
	}
	\subfigure[flex]{
		\label{fig_deep_shallow_flex}
		\includegraphics[width=0.4\textwidth]{flex_deep_shallow}
	}
	\subfigure[sed]{
		\label{fig_deep_shallow_sed}
		\includegraphics[width=0.4\textwidth]{sed_deep_shallow}
	}
